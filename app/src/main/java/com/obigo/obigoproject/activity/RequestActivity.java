...
public class RequestActivity extends MenuActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        code = (Spinner) findViewById(R.id.model_code);
        userRequestPresenter = new UserRequestPresenter(this, code);
    ...
    public void initModelCode() {
        ...
        code.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                Hold = code.getSelectedItemPosition();
            }
    ...
    public void requestUserCar() {
        ...
        Toast.makeText(getApplicationContext(),
                "code : " + modelNameList.get(Hold) + " , " + "color : " + color.getText().toString() +
                        " , " + "location : " + location.getText().toString() + " , " + "vin : " +
                        vin.getText().toString(), Toast.LENGTH_SHORT).show();

        userRequestPresenter.insertUserRequest(new UserRequestVO("ssung", modelCodeList.get(Hold), color.getText().toString(),
